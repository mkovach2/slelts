...
if __name__ == "__main__":
  ...
  #   0,maxLo/euler**2,color = 'r',
  #   lw=lineWidth)
  # # plot_DR.set_title("mode cross section at x = " + 
  # #                         str(np.around(xax2[xMaxLo])) + " μm")
  # # plot_DR.set_xlabel("y (μm)")
  # # plot_DR.set_ylabel("scaled optical intensity vs overall max")
  # plot_DR.set_ylim(bottom=0, top=upperY)
  # # plot_DR.text(xTpos[0],xTpos[1], "MFD = " + \
  ...
  # yTpos = [9,0.6]
  # axAll['xPl'].plot(xax2,lowRow,lw=lineWidth)
  ...
  # xTpos = [9,0.6]
  # axAll['yPl'].plot(yax2,lowCol,lw=lineWidth)
