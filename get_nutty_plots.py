...
# else:
    ...
    csv_in_path = '/mnt/T/Device Components/Grating Coupler/20250611_apo_co_pro_2/MX0095A_FC3R5/g2f11/Cv_peak_stats/12919582_Cv_peak_mean.csv'
    info_path = None
else:
    ...
    csv_str = "450_horiz_rd1_-8deg_18sep_long_xze; 450 horiz; backwards; "+\
    f"18 um separation\n{transmission_str}"
